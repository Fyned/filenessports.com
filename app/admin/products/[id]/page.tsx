  ...
  useEffect(() => {
    async function fetchData() {
      ...
      setFormData({
        ...
        min_width_m: product.min_width_cm ? (product.min_width_cm / 100).toString() : '0.1',
        max_width_m: product.max_width_cm ? (product.max_width_cm / 100).toString() : '20',
        min_height_m: product.min_height_cm ? (product.min_height_cm / 100).toString() : '0.1',
        max_height_m: product.max_height_cm ? (product.max_height_cm / 100).toString() : '20',
